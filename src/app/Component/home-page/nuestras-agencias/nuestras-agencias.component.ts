...
export class NuestrasAgenciasComponent implements OnInit {
	...
	constructor(private _cryptoService: CryptoService, private router: Router, private elementRef: ElementRef) {
		this.agencyView(1);
	}
	...
	agencyView(id: number) {
		this.agencies.filter((agencia: any) => {
