...
describe('PopUpPasajeroComponent', () => {
  let component: PopUpPasajeroVuelosComponent;
  let fixture: ComponentFixture<PopUpPasajeroVuelosComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ PopUpPasajeroVuelosComponent, GetNombrePipe]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(PopUpPasajeroVuelosComponent);
