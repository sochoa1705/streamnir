		...
		if (currentPassengers <= 9 || type==2) {
			switch (type) {
				case 0:
					...
					else if (this.totalINF > totalADT) this.showMessageError("Límite de infantes excedido", "Asegúrate de que la cantidad de adultos sea igual o mayor que la cantidad de infantes.");
				...
				default:
					...
					if (totalINF > this.totalADT) this.showMessageError("Límite de infantes excedido", "Asegúrate de que la cantidad de adultos sea igual o mayor que la cantidad de infantes."); 
